...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "subtree",
            url: "https://github.com/21-DOT-DEV/subtree/releases/download/0.0.12/subtree.artifactbundle.zip",
            checksum: "fd1cfd3755bdda41da41a730cf1385939b7cad7dc72a744fe51153716daeea52"
        ),
