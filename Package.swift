...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "subtree",
            url: "https://github.com/21-DOT-DEV/subtree/releases/download/0.0.8/subtree.artifactbundle.zip",
            checksum: "05987de10253c684b7da84d4bfa0063ae2d285dc73cb30ab690ec7fcdcb831ef"
        ),
